...
def usage():
    print(
        "index_database.py -i <input CSV file> -d <database file> -f <offset>"
    )


def main(argv):
    """ Script to index CRISPRs from a CSV file into a SQLite database.
    Using the files generated using the Gather command (see the README)"""
    inputfiles = []
    dbfile = ""
    offset = 0
